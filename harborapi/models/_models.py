...
#   filename:  https://raw.githubusercontent.com/goharbor/harbor/main/api/v2.0/swagger.yaml
#   timestamp: 2023-05-30T12:46:34+00:00
...
class WebhookTargetObject(BaseModel):
    ...
    payload_format: Optional[PayloadFormatType] = Field(
        None,
