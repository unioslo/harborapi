...
#   filename:  https://converter.swagger.io/api/convert?url=https://raw.githubusercontent.com/goharbor/harbor/main/api/v2.0/swagger.yaml
#   timestamp: 2023-08-21T11:03:36+00:00
...
class NotifyType(BaseModel):
    __root__: str = Field(
        ..., description="Webhook supported notify type.", example="http"
    )


class PayloadFormatType(BaseModel):
    __root__: str = Field(
...
class AdditionLinks(BaseModel):
    __root__: Optional[Dict[str, AdditionLink]] = None
...
class InternalConfigurationsResponse(BaseModel):
    __root__: Optional[Dict[str, InternalConfigurationValue]] = None
...
class ScanOverview(BaseModel):
    __root__: Optional[Dict[str, NativeReportSummary]] = None
