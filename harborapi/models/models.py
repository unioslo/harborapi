...
class ProjectMetadata(BaseModel):
    ...
    def _validate_strbool(
        cls: PyType["BaseModel"], v: Any, info: FieldValidationInfo
    ) -> Any:
...
class PayloadFormat(BaseModel):
    ...
    formats: Optional[List[PayloadFormatType]] = Field(
        None, description="The supported payload formats for this notify type."
    )
...
class Accessory(BaseModel):
    ...
    subject_artifact_digest: Optional[str] = Field(
        None, description="The subject artifact digest of the accessory"
    )
    subject_artifact_repo: Optional[str] = Field(
        None, description="The subject artifact repository name of the accessory"
    )
...
class DangerousCVE(BaseModel):
    ...
    cve_id: Optional[str] = Field(None, description="the cve id")
    severity: Optional[str] = Field(None, description="the severity of the CVE")
    cvss_score_v3: Optional[float] = Field(None, description="the cvss score v3")
    desc: Optional[str] = Field(None, description="the description of the CVE")
    package: Optional[str] = Field(None, description="the package of the CVE")
...
class DangerousArtifact(BaseModel):
    ...
    project_id: Optional[int] = Field(
        None, description="the project id of the artifact"
    )
    repository_name: Optional[str] = Field(
        None, description="the repository name of the artifact"
    )
    digest: Optional[str] = Field(None, description="the digest of the artifact")
    critical_cnt: Optional[int] = Field(
        None, description="the count of critical vulnerabilities"
    )
    high_cnt: Optional[int] = Field(
        None, description="the count of high vulnerabilities"
    )
    medium_cnt: Optional[int] = Field(
        None, description="the count of medium vulnerabilities"
    )
...
class VulnerabilityItem(BaseModel):
    ...
    digest: Optional[str] = Field(None, description="the digest of the artifact")
    tags: Optional[List[str]] = Field(None, description="the tags of the artifact")
    cve_id: Optional[str] = Field(None, description="the CVE id of the vulnerability.")
    severity: Optional[str] = Field(
        None, description="the severity of the vulnerability"
    )
    cvss_v3_score: Optional[float] = Field(
        None, description="the nvd cvss v3 score of the vulnerability"
    )
    package: Optional[str] = Field(None, description="the package of the vulnerability")
    version: Optional[str] = Field(None, description="the version of the package")
    fixed_version: Optional[str] = Field(
        None, description="the fixed version of the package"
    )
...
class SecuritySummary(BaseModel):
    ...
    low_cnt: Optional[int] = Field(None, description="the count of low vulnerabilities")
    none_cnt: Optional[int] = Field(
        None, description="the count of none vulnerabilities"
    )
    unknown_cnt: Optional[int] = Field(
        None, description="the count of unknown vulnerabilities"
    )
    total_vuls: Optional[int] = Field(
        None, description="the count of total vulnerabilities"
    )
    scanned_cnt: Optional[int] = Field(
        None, description="the count of scanned artifacts"
    )
    total_artifact: Optional[int] = Field(
        None, description="the total count of artifacts"
    )
    fixable_cnt: Optional[int] = Field(
        None, description="the count of fixable vulnerabilities"
    )
    dangerous_cves: Optional[List[DangerousCVE]] = Field(
        None, description="the list of dangerous CVEs"
    )
    dangerous_artifacts: Optional[List[DangerousArtifact]] = Field(
        None, description="the list of dangerous artifacts"
    )
